    ...
    return(
        <div className="flex flex-col">
            <div className="flex items-center my-5">
                <button className="w-8 h-8 bg-amber-700 hover:bg-amber-800 active:bg-amber-800 text-white text-lg" onClick={handleClickRemove}>-</button>
                <p className="w-20 text-center">{count}</p>
                <button className="w-8 h-8 bg-amber-700 hover:bg-amber-800 active:bg-amber-800 text-white text-lg" onClick={handleClickAdd}>+</button>
            </div>
